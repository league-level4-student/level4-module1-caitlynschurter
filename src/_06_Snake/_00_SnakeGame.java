...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	private void gameOver() {
		...
		JOptionPane.showMessageDialog(null, "Your snake kicked the bucket");

		// 3. ask them if they want to play again.
		String[] options = new String[] { "Yup", "Nope" };
		int input = JOptionPane.showOptionDialog(null, "Play again?", null, 0, -1, null, options, 0);
